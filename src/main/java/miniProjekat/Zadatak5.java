...
//    Generisan password: eCxdwEeFEx
    ...
    public static String generateCharacter() {
        ...
        characters.add("A"); characters.add("a"); characters.add("0");
        characters.add("B"); characters.add("b"); characters.add("1");
        characters.add("C"); characters.add("c"); characters.add("2");
        characters.add("D"); characters.add("d"); characters.add("3");
        characters.add("E"); characters.add("e"); characters.add("4");
        characters.add("F"); characters.add("f"); characters.add("5");
        characters.add("G"); characters.add("g"); characters.add("6");
        characters.add("H"); characters.add("h"); characters.add("7");
        characters.add("I"); characters.add("i"); characters.add("8");
        characters.add("J"); characters.add("j"); characters.add("9");
        characters.add("K"); characters.add("k");
        characters.add("L"); characters.add("l");
        characters.add("M"); characters.add("m");
        characters.add("N"); characters.add("n");
        characters.add("O"); characters.add("o");
        characters.add("P"); characters.add("p");
        characters.add("Q"); characters.add("q");
        characters.add("R"); characters.add("r");
        characters.add("S"); characters.add("s");
        characters.add("T"); characters.add("t");
        characters.add("U"); characters.add("u");
        characters.add("V"); characters.add("v");
        characters.add("W"); characters.add("w");
        characters.add("X"); characters.add("x");
        characters.add("Y"); characters.add("y");
        characters.add("Z"); characters.add("z");
