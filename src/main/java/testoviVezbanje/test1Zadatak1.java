...
//    Notifikacija: Nova verzija aplikacije je dostupna za instalaciju
    ...
    public static void main(String[] args) {
        ...
        if (majorInsteled == majorNew && minorNew == minorInstaled){
            System.out.println("Već imate instaliranu najnoviju verziju.");
        } else {
